...
cd <repo>
npm install
cp .env.example .env.local   # paste your keys (or skip — see below)
...
- **Huge pages / binary URLs** → content-type check, 1.5 MB HTML cap, 5 KB per-page text cap, 22 KB total LLM digest budget
